...
public class Utils {
    ...
    public static WebElement fluentWait(WebDriver driver, By by, long seconds) {
        ((org.slf4j.Logger) logger).info("Waiting for element: {} with timeout: {} seconds", by, seconds);
    ...
    public static <T> T explicitWait(WebDriver driver, ExpectedCondition<T> condition, long seconds) {
        ((org.slf4j.Logger) logger).info("Waiting with explicit wait: {} seconds", seconds);
